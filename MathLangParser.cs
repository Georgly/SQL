...
public partial class MathLangParser : Antlr.Runtime.Parser
{
	...
	// $ANTLR start "group"
	// MathLang.g:75:1: group : ( '(' term ')' | NUMBER | TEXT | request_params | '(' exprList ')' );
	[GrammarRule("group")]
	private MathLangParser.group_return group()
	{
		...
		try
		{
			...
			// MathLang.g:75:6: ( '(' term ')' | NUMBER | TEXT | request_params | '(' exprList ')' )
			int alt1=5;
			...
			case 31:
				...
				if (((LA1_1>=NUMBER && LA1_1<=TEXT)||LA1_1==MUL||LA1_1==31))
				{
					alt1=1;
				}
